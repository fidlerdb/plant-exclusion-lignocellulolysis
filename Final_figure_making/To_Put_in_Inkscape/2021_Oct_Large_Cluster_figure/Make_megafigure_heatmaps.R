...
source("CAZy_2/Functions/plot_Cluster_Heatmap_MetaboliteBlock_further_edits.R")
...
# glucoseHeatmap + xyloseHeatmap
# 
# cowplot::plot_grid(glucoseHeatmap
#                    , xyloseHeatmap, fucoseHeatmap, ADGHeatmap
#                    , VAHeatmap, HBAHeatmap, BAHeatmap
#                    , ncol = 4)
# 
# cowplot::plot_grid(glucoseHeatmap
#                    , xyloseHeatmap, fucoseHeatmap#, ADGHeatmap
...
#                    #, ncol = 4
#                    )
ggsave("Final_figure_making/To_Put_in_Inkscape/2021_Oct_Large_Cluster_figure/Heatmap_Clusters_Glucose.pdf", glucoseHeatmap
      , width = get_Plot_width(df_glucose)
       ,  height =  8, units = 'in')
ggsave("Final_figure_making/To_Put_in_Inkscape/2021_Oct_Large_Cluster_figure/Heatmap_Clusters_Xylose.pdf", xyloseHeatmap
       , width = get_Plot_width(df_xylose)
       ,  height =  8, units = 'in')
ggsave("Final_figure_making/To_Put_in_Inkscape/2021_Oct_Large_Cluster_figure/Heatmap_Clusters_Fucose.pdf", fucoseHeatmap
       , width = get_Plot_width(df_fucose)
       ,  height =  8, units = 'in')
ggsave("Final_figure_making/To_Put_in_Inkscape/2021_Oct_Large_Cluster_figure/Heatmap_Clusters_Galactose.pdf", ADGHeatmap
       , width = get_Plot_width(df_galactose)
       ,  height =  8, units = 'in')
ggsave("Final_figure_making/To_Put_in_Inkscape/2021_Oct_Large_Cluster_figure/Heatmap_Clusters_Vanillic_Acid.pdf", VAHeatmap
       , width = get_Plot_width(df_va)
       ,  height =  8, units = 'in')
ggsave("Final_figure_making/To_Put_in_Inkscape/2021_Oct_Large_Cluster_figure/Heatmap_Clusters_Benzoic_Acid.pdf", BAHeatmap
       , width = get_Plot_width(df_ba)
       ,  height =  8, units = 'in')
ggsave("Final_figure_making/To_Put_in_Inkscape/2021_Oct_Large_Cluster_figure/Heatmap_Clusters_Hydroxybenzoic_Acid.pdf", HBAHeatmap
